...
export const NewPasswordExpiredBox: FC = () => {
  ...
  const handleClick = async () =>{
    try{
      if(email != undefined){
        ...
        ToastCaller.Info(toast, "Info", "Email informado não encontrado, vamos te reencaminhar para pagina de alteração de senha...", 3000);
        setTimeout(function () {
  ...
  <div className={styles.container}>
    ...
    <div style={{ marginTop: '16px' }}>
      <FilledButton color={FilledColor.budGreen} width="175px" onClick={async () => {await handleClick()}}>
              Reenviar e-mail
      </FilledButton>
    </div>
